      ...
      <div class="container">
        <div class="row gy-4 d-flex justify-content-between">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
            <h2 data-aos="fade-up">Stay Informed with BanjirInfo!</h2>
            <p data-aos="fade-up" data-aos-delay="100">
              Tak ada yang lebih penting daripada keamanan dan kesiapan dalam menghadapi bencana alam, terutama banjir. BanjirInfo.DIY hadir sebagai sumber terpercaya untuk menyediakan informasi terkini tentang situasi banjir di berbagai
              wilayah, langkah-langkah antisipasi yang dapat diambil, serta solusi-solusi tepat untuk mengatasi dampak yang ditimbulkan.
            </p>
          ...
          <div class="col-lg-5 order-1 order-lg-2 img" data-aos="zoom-out">
            <img src="img/img.gif" class="img-fluid mb-3 mb-lg-0" alt="" />
          </div>
        </div>
      </div>
    </section>
